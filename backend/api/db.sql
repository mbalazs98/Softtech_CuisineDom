...
--
CREATE TABLE "recipes_cuisines" ("cuisines_id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "cuisines_name" varchar(50) NOT NULL UNIQUE);
--
...
--
CREATE TABLE "recipes_recipes" ("recipe_id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "recipe_name" varchar(50) NOT NULL, "cooking_method" text NOT NULL UNIQUE, "image" text NULL, "string_ingredients" text NOT NULL, "prep_time" integer NULL, "serving" integer NULL);
--
-- Create model tags
--
...
--
-- Create constraint user_recipes_id on model user_recipes
--
CREATE TABLE "new__recipes_user_recipes" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "recipe_id_id" integer NOT NULL REFERENCES "recipes_recipes" ("recipe_id") DEFERRABLE INITIALLY DEFERRED, "user_id_id" integer NOT NULL REFERENCES "recipes_users" ("user_id") DEFERRABLE INITIALLY DEFERRED, CONSTRAINT "user_recipes_id" UNIQUE ("recipe_id_id", "user_id_id"));
...
--
-- Create constraint recipe_tags_id on model recipe_tags
--
CREATE TABLE "new__recipes_recipe_tags" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "recipe_id_id" integer NOT NULL REFERENCES "recipes_recipes" ("recipe_id") DEFERRABLE INITIALLY DEFERRED, "tag_id_id" integer NOT NULL REFERENCES "recipes_tags" ("tag_id") DEFERRABLE INITIALLY DEFERRED, CONSTRAINT "recipe_tags_id" UNIQUE ("recipe_id_id", "tag_id_id"));
...
CREATE INDEX "recipes_recipe_ingredients_recipe_id_id_2af7aac7" ON "recipes_recipe_ingredients" ("recipe_id_id");
--
-- Create constraint recipe_cuisines_id on model recipe_cuisines
--
CREATE TABLE "new__recipes_recipe_cuisines" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "cuisines_id_id" integer NOT NULL REFERENCES "recipes_cuisines" ("cuisines_id") DEFERRABLE INITIALLY DEFERRED, "recipe_id_id" integer NOT NULL REFERENCES "recipes_recipes" ("recipe_id") DEFERRABLE INITIALLY DEFERRED, CONSTRAINT "recipe_cuisines_id" UNIQUE ("recipe_id_id", "cuisines_id_id"));
INSERT INTO "new__recipes_recipe_cuisines" ("id", "cuisines_id_id", "recipe_id_id") SELECT "id", "cuisines_id_id", "recipe_id_id" FROM "recipes_recipe_cuisines";
